...
// Coding Plan models (api/coding/v3) — per the 2026-09-23 plan overview:
// https://console.volcengine.com/ark/docs/ark/coding-plan-personal-plan-overview
const VOLCENGINE_CODING_MODELS: ModelInfo[] = [
	{
		...
		tooltip:
			"Doubao Seed 2.1 Pro — new flagship, 1M context, 256K output, complex reasoning and long-horizon tasks",
	...
	},
	{
		...
		family: "volcengine",
		version: "seed-2.1-lite",
		tooltip:
			"Doubao Seed 2.1 Lite — light and efficient, 1M context, 256K output, everyday coding",
		maxInputTokens: 1048576,
		maxOutputTokens: 262144,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		tooltip: "Doubao Seed 2.0 Mini — fastest response, 256K context, 128K output, simple coding and completion",
		maxInputTokens: 262144,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		tooltip:
			"Doubao Seed Evolving — self-evolving agent model, weekly upgrades under one ID, 1M context, 256K output",
		maxInputTokens: 1048576,
		maxOutputTokens: 262144,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		family: "volcengine",
		version: "minimax-m3",
		tooltip: "MiniMax M3 — via Volcengine Coding Plan, 1M context, 128K output, vision support",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		name: "Kimi K2.8 Preview (Volcengine)",
		family: "volcengine",
		version: "kimi-k2.8-preview",
		tooltip:
			"Kimi K2.8 Preview — near-K3 quality with higher thinking efficiency, 1M context and 1M output, text and image input",
		maxInputTokens: 1048576,
		maxOutputTokens: 1048576,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		version: "glm-5.3",
		tooltip:
			"GLM-5.3 — via Volcengine Coding Plan, 1M context, 128K output, thinking always on, high deduction rate",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		tooltip: "GLM-5.3 Flash — via Volcengine Coding Plan, 1M context, 128K output, vision support, thinking always on",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		tooltip: "DeepSeek V4 Flash — via Volcengine Coding Plan, 1M context, 384K output, thinking on by default",
		maxInputTokens: 1048576,
		maxOutputTokens: 384000,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		family: "volcengine",
		version: "deepseek-v4-pro",
		tooltip: "DeepSeek V4 Pro — via Volcengine Coding Plan, 1M context, 384K output, thinking on by default",
		maxInputTokens: 1048576,
		maxOutputTokens: 384000,
		baseUrl: VOLCENGINE_CODING_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		name: "DeepSeek V4.1 Flash (Volcengine)",
		family: "volcengine",
...
// Agent Plan models (api/plan/v3) — per the plan overview's model matrix;
// text-generation models only (image/video/voice/embedding excluded).
const VOLCENGINE_AGENT_MODELS: ModelInfo[] = [
	...
	},
	{
		...
		family: "volcengine",
		version: "deepseek-v4-flash",
		tooltip: "DeepSeek V4 Flash — via Volcengine Agent Plan, 1M context, 384K output, thinking on by default",
		maxInputTokens: 1048576,
		maxOutputTokens: 384000,
		baseUrl: VOLCENGINE_AGENT_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		family: "volcengine",
		version: "glm-5.3-flash",
		tooltip: "GLM-5.3 Flash — via Volcengine Agent Plan, 1M context, 128K output, vision support, thinking always on",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_AGENT_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		family: "volcengine",
		version: "minimax-m3",
		tooltip: "MiniMax M3 — via Volcengine Agent Plan, 1M context, 128K output, vision support",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_AGENT_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		version: "glm-5.3",
		tooltip:
			"GLM-5.3 — via Volcengine Agent Plan, 1M context, 128K output, thinking always on, high deduction rate",
		maxInputTokens: 1048576,
		maxOutputTokens: 131072,
		baseUrl: VOLCENGINE_AGENT_BASE_URL,
		thinking: true,
	...
	},
	{
		...
		family: "volcengine",
		version: "deepseek-v4-pro",
		tooltip: "DeepSeek V4 Pro — via Volcengine Agent Plan, 1M context, 384K output, thinking on by default",
		maxInputTokens: 1048576,
		maxOutputTokens: 384000,
		baseUrl: VOLCENGINE_AGENT_BASE_URL,
		thinking: true,
